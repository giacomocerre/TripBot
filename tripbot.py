...
class TripbotSpider(scrapy.Spider):
    ...
    # URL TEXT
    f = open("url_Ristoranti(all_ITA).txt")
    ...
    def parse(self, response):
                ...
                region    = response.xpath('//ul[@class="breadcrumbs"]//li[3]//a//span/text()').extract_first()
                url_key   = response.xpath('//ul[@class="breadcrumbs"]//li[3]//a//span/text()').extract_first()
